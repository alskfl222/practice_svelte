...
<div class="min-h-[40vh] px-8 flex flex-col rounded-2xl bg-white">
	<Title type='s'>보스 추가</Title>
	<Hbar />
	<div class="flex flex-col justify-between py-3 gap-4">
		<div class="w-[150px]">
		...
		<div class="w-[150px]">
			...
			>
				{#if $selectBoss.bossDC}
					<div
						class="w-[150px] h-[72px] border rounded-xl border-black flex justify-center items-center"
					>
						{$selectBoss.bossDC}
					</div>
				{:else}
